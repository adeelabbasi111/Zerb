...
<body class="keyboard-nav">
    ...
    <header class="service-detail-hero section">
        <div class="service-hero-orb" style="background: {service['orb']};"></div>
        ...
        <div class="container">
            ...
            <div class="approach-grid">
                <div class="approach-step">
                    ...
                    <h3 class="t-h3 approach-title" style="font-family: var(--font-body) !important;">Architecture First</h3>
                ...
                <div class="approach-step">
                    ...
                    <h3 class="t-h3 approach-title" style="font-family: var(--font-body) !important;">Performance Obsession</h3>
                ...
                <div class="approach-step">
                    ...
                    <h3 class="t-h3 approach-title" style="font-family: var(--font-body) !important;">Fluid Interactions</h3>
                ...
                <div class="approach-step">
                    ...
                    <h3 class="t-h3 approach-title" style="font-family: var(--font-body) !important;">Bulletproof Deployment</h3>
